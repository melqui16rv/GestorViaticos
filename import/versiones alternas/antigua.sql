...
CREATE TABLE `saldos_asignados` (
  ...
  CONSTRAINT `fk_saldos_crp` FOREIGN KEY (`rp_id`) REFERENCES `crp` (`rp_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_saldos_cdp` FOREIGN KEY (`cdp_id`) REFERENCES `cdp` (`cdp_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
