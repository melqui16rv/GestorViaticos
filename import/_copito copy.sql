...
CREATE TABLE `cdp` (
  `UNICO_CDP` VARCHAR(255) NOT NULL,
  ...
  PRIMARY KEY (`UNICO_CDP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE `crp` (
  `UNICO_CRP` VARCHAR(55) NOT NULL,
  `UNICO_CDP` VARCHAR(55) NOT NULL,
  ...
  PRIMARY KEY (`UNICO_CRP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE `op` (
  `UNICO_OP` VARCHAR(55) NOT NULL,
  `UNICO_CRP` VARCHAR(55) NOT NULL,
  `UNICO_CDP` VARCHAR(55) NOT NULL,
...
CREATE TABLE `saldos_asignados` (
  ...
  CONSTRAINT `fk_saldos_crp` FOREIGN KEY (`UNICO_CRP`) REFERENCES `crp` (`UNICO_CRP`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_saldos_cdp` FOREIGN KEY (`UNICO_CDP`) REFERENCES `cdp` (`UNICO_CDP`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
