...
<div style="margin-bottom: 1.5em;">
    <h3 style="font-size:1.15em; color:#1e293b; font-weight:600; margin-bottom:0.2em;">Resumen de Proyectos de Extensionismo</h3>
    <p style="font-size:1em; color:#334155; margin:0;">
        <strong>Meta:</strong> <?php echo $meta_total; ?> &nbsp;|&nbsp;
        <strong>Terminados:</strong> <?php echo $resumen['total_terminados']; ?> (<?php echo $porcentaje_terminados; ?>%) &nbsp;|&nbsp;
        <strong>En Proceso:</strong> <?php echo $resumen['total_en_proceso']; ?> &nbsp;|&nbsp;
        <strong>Proyección:</strong> <?php echo $total_esperado; ?> (<?php echo $porcentaje_esperado; ?>%)
    </p>
</div>

<img src="<?php echo $chartUrl; ?>" alt="Gráfica Proyectos de Extensionismo" class="grafica-img">
