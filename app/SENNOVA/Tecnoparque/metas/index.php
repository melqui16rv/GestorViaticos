...
.sidebar-filament .sidebar-link {
    color: #cbd5e1;
    transition: background 0.3s, color 0.3s;
}
.sidebar-filament .sidebar-link:hover,
.sidebar-filament .sidebar-link.active {
    background: #2563eb;
    color: #fff;
    border-right: 4px solid #1e40af;
}
.sidebar-filament .sidebar-link i {
    font-size: 1.2rem;
}
.sidebar-filament .p-4 {
    color: #94a3b8;
}
