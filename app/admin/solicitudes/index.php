...
<head>
    <meta charset="UTF-8">
    <title>Gestión de Solicitudes de Rol - Admin</title>
...
<body class="bg-gray-50 min-h-screen relative">
    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebarFilament" class="sidebar-filament bg-white border-r border-gray-200 flex flex-col h-screen fixed lg:static left-0 top-0">
            <div class="flex items-center border-b border-gray-200 relative h-16">
                <span class="text-xl font-bold text-blue-700 mx-auto justify-center" style="color: #2b3b4f;">Acciones</span>
            </div>
            <nav class="flex-1 py-4">
                <ul>
                    <li>
                        <a href="#" id="navPendientes" class="sidebar-link flex items-center px-6 py-3 text-gray-700 font-medium cursor-pointer active">
                            <i class="ti ti-clock-hour-4 mr-3"></i> Gestión de Solicitudes
                        </a>
                    </li>
                </ul>
            </nav>
            <div class="p-4 border-t border-gray-200 text-xs text-gray-500">
                &copy; <?php echo date('Y'); ?> CFPI - CIDE
            </div>
        </aside>

        <!-- Contenido principal -->
        <main id="mainContentFilament" class="main-content-filament flex-1 min-h-screen transition-all duration-200 sidebar-open" style="overflow: scroll;height: 100vh;">
            <!-- Vista de Gestión de Solicitudes -->
            <div id="viewPendientes" style="display: block;">
                <iframe src="pendientes.php" style="width: 100%; height: 100vh; border: none;"></iframe>
            </div>
        </main>
    </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Ya no necesitamos navegación entre vistas, solo manejamos el sidebar
...
/* Fijo para los iconos del toggle del sidebar */
.toggle-icon {
    width: 20px;
    height: 20px;
}
