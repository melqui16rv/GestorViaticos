...
<body class="filament-body">
    ...
    <div class="filament-card">
        ...
        <form action="procesar_saldo.php" method="POST" class="filament-form" enctype="multipart/form-data">
            ...
            <div class="filament-form-group">
                <label for="imagen_saldo" class="filament-form-label">Imagen (opcional):</label>
                <input type="file" id="imagen_saldo" name="imagen_saldo" class="filament-form-input">
            </div>
